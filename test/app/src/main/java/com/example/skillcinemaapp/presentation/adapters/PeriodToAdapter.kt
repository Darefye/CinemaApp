...
class PeriodToAdapter(
    val onYearToClick: (Int) -> Unit, private val selectedItem: Int, private val yearsOK: Boolean
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): YearToViewHolder {
        return YearToViewHolder(
            ...
            ), onYearToClick = onYearToClick, selectedItem = selectedItem, yearsOK = yearsOK
        )
    }
