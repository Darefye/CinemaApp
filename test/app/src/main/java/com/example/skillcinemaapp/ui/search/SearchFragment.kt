...
class SearchFragment : Fragment() {
    ...
    private val searchAdapter = SearchResultAdapter(onSearchMovieItemClick = { itemCustom ->
        onSearchMovieItemClick(itemCustom)
    })
            ...
            movieViewModel.loadingState.collectLatest {
                when (it) {
                    LoadingState.IsLoading -> {
                        binding.loaderSearch.isVisible = true
                    }
                    LoadingState.LoadingIsFinished -> {
                        binding.loaderSearch.isVisible = false
                    }
                }
            }
        }
