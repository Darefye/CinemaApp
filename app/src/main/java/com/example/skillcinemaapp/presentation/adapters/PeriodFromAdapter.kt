...
class PeriodFromAdapter(
    val onYearFromClick: (Int) -> Unit, private val selectedItem: Int, private val yearsOK: Boolean
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): YearViewHolder {
        return YearViewHolder(
            ...
            ), onYearFromClick = onYearFromClick, selectedItem = selectedItem, yearsOK = yearsOK
        )
    }
